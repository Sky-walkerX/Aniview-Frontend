...
// Helper function to get auth token (httpOnly cookies are handled automatically)
const getAuthToken = () => {
  // With httpOnly cookies, we don't need to manually get the token
  // The browser will automatically include the cookies in requests
  return 'cookie-auth' // Placeholder to indicate cookie auth is being used
}
